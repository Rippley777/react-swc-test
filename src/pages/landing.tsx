...
const Landing = () => {
  ...
  return (
    ...
    >
      <div className="relative top-1/2 flex flex-col gap-y-4 items-center">
        {showSignUp ? (
          <div>Sign Up</div>
        ) : (
          <>
            ...
            <button
              className="opacity-90 w-40 p-3 text-3xl text-black bg-[#84f401] border-black border-2 rounded-lg"
              onClick={handleLogin}
            >
              Login
            </button>
